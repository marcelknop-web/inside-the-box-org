...
const CyberCrisisSimulator = forwardRef<CrisisSimulatorHandle, CrisisSimulatorProps>(({ embedded = false }, ref) => {
  ...
  const startScreenJSX = (
    <div className={`flex-1 flex items-center justify-center ${embedded ? "py-3" : ""} overflow-y-auto`}>
      <div className="text-center max-w-[520px] px-4">
        <div className="flex justify-center mb-2">
          <div className="opacity-70" style={{ transform: 'scale(2.5)', transformOrigin: 'center center', width: 24, height: 24, margin: '16px auto' }}>
        ...
        {startScreenTitleDone && (
          <>
            ...
            <div className="text-foreground/60 text-sm italic max-w-lg mx-auto leading-relaxed whitespace-pre-line mb-3">
              {t('crisisSim.scenarioIntro')}
            </div>
            <div className="text-center leading-relaxed text-foreground/80 text-sm max-w-lg mx-auto whitespace-pre-line mb-4">
