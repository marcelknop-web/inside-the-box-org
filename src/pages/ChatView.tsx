...
const ChatView = () => {
  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      ...
      fr: [
        // Short (≤34) — niveau expert, mobile
        'Cadrage TLPT TIBER-EU ?',
        'DORA Art. 28 concentration ?',
        'NIS-2 art. 21 mesures min. ?',
        'Conformité CRA sans CE ?',
        'IEC 62443-3-3 SL-T mapping ?',
        'Modèle Purdue encore valable ?',
        'Zones et conduits prioriser ?',
        'Opérationnaliser l\'appétit ?',
        'Crown jewel mapping à jour ?',
        'NIST CSF 2.0 fonction Govern ?',
        'Couverture MITRE ATT&CK ?',
        'Backlog detection engineering ?',
        'Test de résilience threat-led ?',
        'Cyber resilience posture index ?',
        'Maturité des playbooks SOAR ?',
        'PAM sans modèle de tier ?',
        'ITDR sur AD/Entra/SaaS ?',
        'SBOM dans la supply chain ?',
        'Migration post-quantique ?',
        'Stratégie cloud exit testable ?',
        'Retainer IR bien dimensionné ?',
        'Forensic readiness DFIR ?',
        'Directive CER vs NIS-2 ?',
        'BCM ISO 22301 maturité ?',
        'Seuils Major Incident clairs ?',
        'Agrégation risque vers comex ?',
        'Trois lignes de défense ?',
        'Audit trail des outils IA ?',
        'EU AI Act haut risque ?',
        'TLPT vs red team classique ?',
