  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      de: [
        ...
        'Welche SAQ brauche ich für PCI-DSS?',
      ...
      en: [
        ...
        'What is a TLPT and do I need one?',
        ...
        'Which SAQ do I need for PCI-DSS?',
      ...
      fr: [
        ...
        'Qu\'est-ce qu\'un TLPT et en ai-je besoin ?',
        ...
        'Que couvre le Cyber Resilience Act ?',
