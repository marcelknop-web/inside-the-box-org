...
const ChatView = () => {
  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      de: [
        // Short (≤34) — mobile-friendly, substantive
        'Welches Tool passt zu NIS-2?',
        'Wann ist der nächste TTX-Termin?',
        'Was ist ein DORA Major Incident?',
        'Wer fällt unter NIS-2?',
        'Was ist ein TLPT?',
        'NIS-2 vs DORA Geltungsbereich?',
        'Was ist ein BIA?',
        'Wie reift mein ISMS?',
        'Was ist Threat-Led Pen-Testing?',
        'Welche SAQ für PCI-DSS?',
        'TISAX AL2 oder AL3?',
        'IEC 62443 SL-T bestimmen?',
        'Was deckt der CRA ab?',
        'NIS-2 Geldbußen Höhe?',
        'DORA Meldefristen kurz?',
        'CISO unter NIS-2 Pflicht?',
        'Vorstandshaftung NIS-2?',
        'Was ist ein Krisenstab?',
        'Welche KRI/KPI für SOC?',
        'Lieferkettenrisiko prüfen?',
        'MITRE ATT&CK im SOC nutzen?',
        'Was ist Purple Teaming?',
        'EDR vs XDR Unterschied?',
        'Was ist Zero Trust konkret?',
        'SBOM nach CRA Pflicht?',
        'OT-Segmentierung Ansatz?',
        'IR-Plan Pflichtbestandteile?',
        'Was ist Recovery Time Objective?',
        'NIST CSF 2.0 Neuerungen?',
        ...
        'Wann ist ein DORA-Vorfall ein Major Incident?',
        'Wie bewerte ich kritische ICT-Drittanbieter?',
        'Was prüft ein NIS-2 Audit konkret?',
        'Welche Pflichten hat die Geschäftsleitung?',
        'Wie sieht ein Business Impact Assessment aus?',
        'Was unterscheidet IEC 62443 von ISO 27001?',
        'Wie auditiere ich OT-Umgebungen sicher?',
        'Wie klassifiziere ich nach TISAX AL2 vs AL3?',
        'Wie reife ich mein ISMS in 12 Monaten?',
        'Welche Krisenstabsrollen sind Pflicht?',
        'Wie übe ich Ransomware realistisch?',
        'Was gehört in einen Incident Response Plan?',
        'Wie messe ich SOC-Effektivität?',
        'Wie priorisiere ich Findings nach Audit?',
        'Wie schreibe ich einen audit-fähigen Report?',
        'Welche KPIs braucht ein Vorstand?',
        'Wie setze ich Lessons Learned um?',
        'Welche Threat-Intel-Quellen sind seriös?',
        'Wie integriere ich Lieferanten in mein ISMS?',
        'Wie strukturiere ich ein Red-Team-Mandat?',
        'Welche Logquellen muss mein SIEM abdecken?',
        'Wie validiere ich Backups gegen Ransomware?',
        'Wie etabliere ich ein Vulnerability-Programm?',
        'Wie messe ich Mean Time to Detect?',
        'Wie gestalte ich DSGVO-konforme IR-Forensik?',
        'Wie führe ich ein DORA-Selbst­assessment durch?',
        'Wie dokumentiere ich Risikoakzeptanz revisionssicher?',
        'Wie integriere ich SBOM in den SDLC?',
        'Welche Anforderungen hat NIS-2 an Awareness?',
        'Wie strukturiere ich ein TPRM-Programm?',
        'Wie eskaliere ich Incidents an die Behörde?',
      ],
      en: [
        // Short (≤34)
        ...
        'NIS-2 vs DORA scope?',
        'What is a BIA?',
        'How do I mature my ISMS?',
        'Which SAQ for PCI-DSS?',
        'TISAX AL2 or AL3?',
        'IEC 62443 SL-T how to set?',
        'What does the CRA cover?',
        'NIS-2 fine levels?',
        'DORA reporting deadlines?',
        'CISO mandatory under NIS-2?',
        'Board liability under NIS-2?',
        'What is a crisis cell?',
        'Which KPIs for a SOC?',
        'Supply chain risk check?',
        'MITRE ATT&CK in the SOC?',
        'What is purple teaming?',
        'EDR vs XDR difference?',
        'Zero Trust in practice?',
        'SBOM mandatory under CRA?',
        'OT segmentation approach?',
        'Mandatory parts of an IR plan?',
        'What is RTO vs RPO?',
        'NIST CSF 2.0 what is new?',
        'ISO 27001:2022 Annex A?',
        'What is threat-led pen test?',
        // Long
        ...
        'When is a DORA incident a major incident?',
        'How do I assess critical ICT third parties?',
        'What does a NIS-2 audit actually check?',
        'Do I need a CISO under NIS-2?',
        'What are management board obligations?',
        'What does a Business Impact Assessment look like?',
        'How does IEC 62443 differ from ISO 27001?',
        'How do I audit OT environments safely?',
        'How do I classify TISAX AL2 vs AL3?',
        'How do I mature my ISMS in 12 months?',
        'Which crisis team roles are mandatory?',
        'How do I exercise ransomware realistically?',
        'What belongs in an Incident Response Plan?',
        'How do I measure SOC effectiveness?',
        'How do I prioritize findings after an audit?',
        'How do I write an audit-grade report?',
        'Which KPIs does a board need?',
        'How do I implement lessons learned?',
        'Which threat intel sources are credible?',
        'How do I integrate suppliers into my ISMS?',
        'How do I structure a red team mandate?',
        'Which log sources must my SIEM cover?',
        'How do I validate backups against ransomware?',
        'How do I run a vulnerability management programme?',
        'How do I measure mean time to detect?',
        'How do I run GDPR-compliant IR forensics?',
        'How do I run a DORA self-assessment?',
        'How do I document risk acceptance for audit?',
        'How do I integrate SBOM into the SDLC?',
        'What are NIS-2 requirements for awareness?',
        'How do I build a TPRM programme?',
        'How do I escalate incidents to the regulator?',
      ],
      fr: [
        // Short (≤34)
        'Quel outil pour NIS-2 ?',
        'Prochaine session TTX ?',
        'Incident majeur DORA ?',
        'Qui est concerné par NIS-2 ?',
        'Qu\'est-ce qu\'un TLPT ?',
        'NIS-2 vs DORA périmètre ?',
        'Qu\'est-ce qu\'un BIA ?',
        'Quel SAQ pour PCI-DSS ?',
        'TISAX AL2 ou AL3 ?',
        'Que couvre le CRA ?',
        'Sanctions NIS-2 ?',
        'Délais DORA en bref ?',
        'CISO obligatoire NIS-2 ?',
        'Responsabilité du board ?',
        'Cellule de crise rôles ?',
        'KPI pour un SOC ?',
        'Risque chaîne d\'appro ?',
        'MITRE ATT&CK au SOC ?',
        'Purple teaming c\'est quoi ?',
        'EDR vs XDR différence ?',
        'Zero Trust concrètement ?',
        'SBOM obligatoire CRA ?',
        'Segmentation OT ?',
        'Plan de réponse parts ?',
        'RTO vs RPO ?',
        'NIST CSF 2.0 nouveautés ?',
        ...
        'En quoi NIS-2 diffère-t-elle de DORA ?',
        'Quels sont les délais de notification DORA ?',
        'Quand un incident DORA est-il majeur ?',
        'Comment évaluer les tiers ICT critiques ?',
        'Que vérifie concrètement un audit NIS-2 ?',
        'Faut-il un CISO sous NIS-2 ?',
        'Quelles obligations pour la direction ?',
        'À quoi ressemble une analyse d\'impact ?',
        'IEC 62443 vs ISO 27001, quelle différence ?',
        'Comment auditer un environnement OT ?',
        'Comment classer TISAX AL2 vs AL3 ?',
        'Comment faire mûrir un SMSI en 12 mois ?',
        'Quels rôles de cellule de crise sont obligatoires ?',
        'Comment exercer un scénario rançongiciel ?',
        'Que contient un plan de réponse aux incidents ?',
        'Comment mesurer l\'efficacité d\'un SOC ?',
        'Comment prioriser les findings après audit ?',
        'Comment rédiger un rapport audit-grade ?',
        'Quels KPI pour un conseil d\'administration ?',
        'Comment appliquer les leçons apprises ?',
        'Quelles sources de threat intel fiables ?',
        'Comment intégrer les fournisseurs au SMSI ?',
        'Comment structurer un mandat red team ?',
        'Quelles sources de logs pour le SIEM ?',
        'Comment valider les backups face au ransomware ?',
        'Comment piloter un programme de vulnérabilités ?',
        'Comment mesurer le MTTD ?',
        'Comment mener une forensique IR conforme RGPD ?',
        'Comment réaliser un auto-assessment DORA ?',
        'Comment documenter une acceptation de risque ?',
        'Comment intégrer le SBOM au SDLC ?',
        'Exigences NIS-2 pour la sensibilisation ?',
        'Comment bâtir un programme TPRM ?',
        'Comment escalader un incident au régulateur ?',
      ],
    } as const;
