  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      ...
      fr: [
        ...
        // Short (≤34) — findings d'audit typiques
        'Inventaire d\'actifs incomplet ?',
        'Patch management lacunaire ?',
        'Pas de MFA pour les admins ?',
        'Restauration jamais testée ?',
        'IRP uniquement sur papier ?',
        'Logs jamais exploités ?',
        'Droits jamais recertifiés ?',
        'Pas de PCA pour le critique ?',
        'Fournisseurs non évalués ?',
        'Sensibilisation 1x par an ?',
        'OT non segmenté du SI ?',
        'Analyse de risque obsolète ?',
        'Scans sans remédiation ?',
        'Comptes partagés en service ?',
