...
const ChatView = () => {
  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      de: [
        // Short (≤34) — Expert-Level, mobil-tauglich
        'TLPT-Scoping nach TIBER-EU?',
        'DORA Art. 28 Konzentration?',
        'NIS-2 §30 Mindestmaßnahmen?',
        'CRA-Konformität ohne CE?',
        'IEC 62443-3-3 SL-T mappen?',
        'Purdue-Modell noch tragfähig?',
        'Zonen & Conduits priorisieren?',
        'Risikoappetit operationalisieren?',
        'Crown Jewel Mapping aktuell?',
        'KRITIS §8a Prüfnachweis?',
        'NIST CSF 2.0 Govern-Funktion?',
        'MITRE ATT&CK Coverage messen?',
        'Detection Engineering Backlog?',
        'Threat-Led Resilience Test?',
        'Cyber-Resilience-Posture-Index?',
        'SOAR-Playbook-Reifegrad?',
        'PAM ohne Tier-Modell tragbar?',
        'Identity Threat Detection?',
        'SBOM-Pflicht in der Lieferkette?',
        'Post-Quantum-Migration starten?',
        'Cloud-Exit-Strategie testbar?',
        'IR-Retainer richtig dimensionieren?',
        'Forensik-Readiness im DFIR?',
        'KRITIS-Sektor-Schwellenwerte?',
        'BCM nach ISO 22301 reif?',
        'Major Incident: Schwellen klar?',
        'Risiko-Aggregation auf Vorstand?',
        'Three Lines of Defense gelebt?',
        'Audit-Trail bei KI-Tools?',
        'EU AI Act Hochrisiko-System?',
        ...
        // Long — Expert-Level
        'Wie scopen wir einen TLPT nach TIBER-EU sinnvoll auf unsere kritischen Funktionen?',
        'Wie identifizieren und reduzieren wir Konzentrationsrisiken bei IKT-Drittparteien nach DORA Art. 28?',
        'Wie operationalisieren wir die Govern-Funktion des NIST CSF 2.0 in einem konzernweiten ISMS?',
        'Wie mappen wir IEC 62443-3-3 Security-Level-Targets auf bestehende OT-Zonen und Conduits?',
        'Wie führen wir ein Crown-Jewel-Mapping mit klarer Verbindung zu BIA und Bedrohungsmodell?',
        'Wie etablieren wir ein belastbares Detection-Engineering nach MITRE ATT&CK mit messbarer Coverage?',
        'Wie verzahnen wir Cyber-Resilience-Tests mit DORA-Vorgaben zu Threat-Led Penetration Testing?',
        'Wie strukturieren wir Identity Threat Detection & Response über AD, Entra ID und SaaS hinweg?',
        'Wie überführen wir SOAR-Playbooks aus Skript-Sammlungen in ein gepflegtes Engineering-Asset?',
        'Wie entwickeln wir eine Post-Quantum-Migrationsstrategie für PKI, TLS und Code Signing?',
        'Wie machen wir Cloud-Exit-Strategien für hyperscale-abhängige Workloads tatsächlich testbar?',
        'Wie integrieren wir SBOM-Anforderungen aus EU-CRA und SecureSDLC in unsere Lieferketten-Governance?',
        'Wie aggregieren wir technische Risiken zu einer auf Vorstandsebene tragfähigen Risikoposition?',
        'Wie operationalisieren wir Three Lines of Defense in einer Matrix mit IT, OT und Konzernsicherheit?',
        'Wie strukturieren wir DORA Major-Incident-Klassifikation, NIS-2 24-h-Frühwarnung und DSGVO 33 in einem Workflow?',
        'Wie binden wir EU AI Act Hochrisiko-Systeme in unser ISMS und unser Risikoregister ein?',
      ...
      en: [
        // Short (≤34) — expert-level, mobile-friendly
        'TLPT scoping under TIBER-EU?',
        'DORA Art. 28 concentration?',
        'NIS-2 Art. 21 minimum measures?',
        'CRA conformity without CE?',
        'IEC 62443-3-3 SL-T mapping?',
        'Purdue model still viable?',
        'Zones & conduits priority?',
        'Operationalising risk appetite?',
        'Crown jewel mapping current?',
        'NIST CSF 2.0 Govern function?',
        'MITRE ATT&CK coverage metric?',
        'Detection engineering backlog?',
        'Threat-led resilience test?',
        'Cyber resilience posture index?',
        'SOAR playbook maturity?',
        'PAM without tier model?',
        'Identity threat detection gap?',
        'SBOM duty across the chain?',
        'Post-quantum migration start?',
        'Cloud exit strategy testable?',
        'IR retainer right-sized?',
        'Forensic readiness in DFIR?',
        'CER Directive vs NIS-2 scope?',
        'BCM ISO 22301 maturity?',
        'Major incident thresholds?',
        'Risk aggregation to the board?',
        'Three lines of defence real?',
        'Audit trail in AI tooling?',
        'EU AI Act high-risk system?',
        'DORA TLPT vs red team?',
