  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      ...
      en: [
        ...
        // Short (≤34) — typical audit findings
        'Asset inventory incomplete?',
        'Patch management gaps?',
        'No MFA for admins?',
        'Backups never restore-tested?',
        'IRP only on paper?',
        'Logs collected, never reviewed?',
        'Access rights never recertified?',
        'No BCM for key processes?',
        'Suppliers never risk-rated?',
        'Awareness only once a year?',
        'No OT network segmentation?',
        'Risk assessment outdated?',
        'Vuln scans without fixes?',
        'Shared accounts still in use?',
        'No documented crypto policy?',
