  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      de: [
        ...
        // Long — typische Audit-Findings
        'Was tun, wenn das Asset-Inventar im Audit als unvollständig auffällt?',
        'Warum scheitert Patch-Management so oft an OT-Systemen?',
        'Wie schließen wir das Finding „MFA fehlt für privilegierte Konten"?',
        'Wie beweisen wir dem Auditor, dass Backups wirklich wiederherstellbar sind?',
        'Wie kommen wir aus einem „IRP nur auf Papier"-Finding heraus?',
        'Wie etablieren wir eine belastbare Log- und SIEM-Auswertung?',
        'Wie organisieren wir eine saubere Berechtigungs-Rezertifizierung?',
        'Was erwartet der Auditor von unserem Lieferanten-Risikomanagement?',
        'Wie heben wir Awareness vom Pflichtmodul auf wirksames Verhalten?',
        'Wie schließen wir Findings zu fehlender OT-Netzsegmentierung?',
        'Wie halten wir die Risikoanalyse ohne ständigen Mehraufwand aktuell?',
        'Wie priorisieren wir Schwachstellen-Findings nach echtem Risiko?',
        'Wie ersetzen wir Shared Accounts ohne den Betrieb lahmzulegen?',
        'Wie erstellen wir ein auditfestes Krypto- und Schlüsselkonzept?',
        'Wie reagieren wir richtig auf wiederkehrende Findings im Re-Audit?',
      ],
      en: [
