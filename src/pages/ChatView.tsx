...
const useServiceContent = () => {
  ...
  const contentMap: Record<string, () => ReactNode> = {
    isms: () => (
      <TypedSection title={t('isms.title')} mode="word" charDelay={40} intro={<p>{t('isms.intro')}</p>}>
    ...
    'nis2-dora': () => (
      <TypedSection title={t('nis2.title')} mode="word" charDelay={40} intro={<p>{t('nis2.intro')}</p>}>
    ...
    'tisax-pci-dss': () => (
      <TypedSection title={t('tisax.title')} mode="word" charDelay={40} intro={<p>{t('tisax.intro')}</p>}>
    ...
    'assessments-concepts': () => (
      <TypedSection title={t('assessments.title')} mode="word" charDelay={40} intro={<p>{t('assessments.intro')}</p>}>
    ...
    'incident-management': () => (
      <TypedSection title={t('incident.title')} mode="word" charDelay={40} intro={<p>{t('incident.intro')}</p>}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
    ...
    'cyber-crisis-management': () => (
      <TypedSection title={t('cyberCrisis.title')} mode="word" charDelay={40} intro={<p>{t('cyberCrisis.intro')}</p>}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
    ...
    'arena-training': () => (
      <TypedSection title={t('arena.title')} mode="word" charDelay={40} intro={<p>{t('arena.intro')}</p>}>
    ...
    'events-workshops': () => (
      <TypedSection title={t('events.title')} mode="word" charDelay={40} intro={<p>{t('events.intro')}</p>}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
    ...
    publications: () => (
      <TypedSection title={t('publications.title')} mode="word" charDelay={40} intro={<p>{t('publications.intro')}</p>}>
    ...
    'virtual-ciso': () => (
      <TypedSection title={t('vciso.title')} mode="word" charDelay={40} intro={<p>{t('vciso.intro')}</p>}>
    ...
    'ai-workflows': () => (
      <TypedSection title={t('aiWorkflows.title')} mode="word" charDelay={40} intro={<p>{t('aiWorkflows.intro')}</p>}>
    ...
    training: () => (
      <TypedSection title={t('training.title')} mode="word" charDelay={40} intro={<p>{t('training.subtitle')}</p>}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
    ...
    consulting: () => (
      <TypedSection title={t('consulting.title')} mode="word" charDelay={40} intro={<p>{t('consulting.intro')}</p>}>
    ...
    'by-whom': () => {
      ...
      return (
        <TypedSection title={t('byWhom.title')} mode="word" charDelay={40} intro={<p>{t('byWhom.intro')}</p>}>
          {profiles.map(p => (
    ...
    contact: () => (
      <TypedSection title={t('contact.title')} mode="word" charDelay={40} intro={<p>{t('contact.intro')}</p>}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
    ...
    imprint: () => (
      <TypedSection title={t('imprint.title')} mode="word" charDelay={40}>
    ...
    'tech-requirements': () => {
      ...
      return (
        <TypedSection title={t('techReq.title')} mode="word" charDelay={40} intro={<p>{t('techReq.intro')}</p>}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            <div className="rounded-xl p-4 bg-primary/5 border border-primary/20">
              <div className="flex items-center gap-2 mb-2">
