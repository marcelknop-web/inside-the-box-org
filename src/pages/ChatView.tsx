  ...
  const exampleQuestions = useMemo(() => {
    const all = {
      de: [
        ...
        // Short (≤34) — typische Audit-Findings
        'Asset-Inventar unvollständig?',
        'Patch-Management lückenhaft?',
        'Keine MFA für Admins?',
        'Backups nie restore-getestet?',
        'IRP existiert nur auf Papier?',
        'Logs werden nicht ausgewertet?',
        'Berechtigungen nie rezertifiziert?',
        'Kein BCM für Schlüsselprozesse?',
        'Lieferanten nicht risikobewertet?',
        'Awareness nur einmal jährlich?',
        'Keine Netzsegmentierung im OT?',
        'Risikoanalyse veraltet?',
        'Schwachstellenscan ohne Fix?',
        'Shared Accounts noch im Einsatz?',
        'Kein Krypto-Konzept dokumentiert?',
