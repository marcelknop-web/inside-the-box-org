  ...
  return (
    <PageLayout>
      <div className="space-y-8">
        <PageMeta title="Virtual CISO" description="Executive cybersecurity leadership on a flexible engagement model. Strategic direction without a full-time hire." />
