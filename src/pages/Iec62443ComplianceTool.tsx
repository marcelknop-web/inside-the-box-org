...
function ReportView({ intakeData, threats, reqs, reviewSummary }: { intakeData: IecIntakeData; threats: IecThreat[]; reqs: IecReq[]; reviewSummary: ReviewSummaryResult | null }) {
  ...
  return (
    <StaggerReveal resetKey="rp" stagger={300}>
      <InfoBox icon="✅" title="Applicability Review Complete" color="green">The IACS UR E27 applicability review has been performed. Run the quality check to validate the report before export.</InfoBox>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="border-l-4 border-primary p-6">
          <div className="flex flex-col sm:flex-row items-start justify-between gap-3">
            <div>
              <div className="text-[11px] font-semibold text-muted-foreground uppercase tracking-widest mb-1">IACS UR E27 Applicability Review</div>
