...
export const THREATS: Threat[] = [
  ...
  { id: 1, stride: 'S', name: 'Spoofing des MQTT-Brokers (Identitätsvortäuschung)', component: 'MQTT-Interface — Broker-Authentifizierung', attacker: 'Externer Angreifer', path: 'Angreifer positioniert sich als legitimer MQTT-Broker → Gerät verbindet sich mit False-Server → Datenabfluss', cra: 'Annex I, Part I, Nr. 3', likelihood: 3, impact: 4,
    ...
    rationale: 'Likelihood 3: Erfordert Netzwerkzugang und ARP-Spoofing-Setup, aber Standard-Tooling verfügbar. Impact 4: Vollständiger Datenabfluss aller Sensordaten möglich, zusätzlich Fake-Daten an Clients injizierbar.',
  ...
  { id: 10, stride: 'T', name: 'Modbus-Register-Manipulation (unauthentifiziert)', component: 'Modbus-Interface', attacker: 'Netzwerk-Angreifer (Layer 2)', path: 'Modbus TCP hat keine Authentifizierung → Angreifer im Netzwerk kann Holding-Register beschreiben → Prozessparameter-Manipulation', cra: 'Annex I, Part I, Nr. 5', likelihood: 4, impact: 5,
    ...
    rationale: 'Likelihood 4: Standard-Modbus-Tools (mbtcp-cli, pymodbus) frei verfügbar, kein Auth erforderlich. Impact 5: Direkte Manipulation von Steuerungsparametern mit potenziellen Safety-Auswirkungen in OT-Umgebung.',
  ...
  { id: 5, stride: 'I', name: 'Klartext-MQTT (Port 1883) — Vertraulichkeitsverlust', component: 'MQTT-Interface — Transportschicht', attacker: 'Netzwerk-Mitleser (MITM)', path: 'Unverschlüsselte MQTT-Verbindung → Passwort-Sniffing → Vollzugriff auf Sensordaten', cra: 'Annex I, Part I, Nr. 4', likelihood: 5, impact: 5,
    ...
    rationale: 'Likelihood 5: Passives Mitlesen im gleichen Netzwerksegment trivial, kein aktiver Angriff nötig, Layer-2-Zugang in OT-Netzen Standard. Impact 5: Vollständige Offenlegung aller Sensordaten und Zugangsdaten in Industriekontext — Fabrikgeheimnisse + Steuerungsdaten betroffen, ermöglicht Folge-Angriffe.',
    sources: ['CRA Annex I, Part I, Nr. 4: Vertraulichkeit von Daten', 'ETSI EN 303 645, Provision 5.8-1: Kommunikationssicherheit'] },
  { id: 11, stride: 'I', name: 'OPC-UA Security Mode None — Datenabfluss', component: 'OPC-UA Client', attacker: 'Netzwerk-Mitleser', path: 'OPC-UA Security Mode auf "None" konfiguriert → Alle Prozessdaten unverschlüsselt → Industriegeheimnisse exponiert', cra: 'Annex I, Part I, Nr. 4', likelihood: 3, impact: 4,
    ...
    rationale: 'Likelihood 3: Erfordert Netzwerkzugang zum OT-Segment, dort aber trivial mitzulesen. Impact 4: Prozessdaten und Produktionsparameter offengelegt, kein direkter Steuerungszugriff über diesen Vektor.',
