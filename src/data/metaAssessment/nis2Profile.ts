...
export const NIS2_PROFILE: StandardProfile = {
  ...
  requirements: [
    { id: 'A20-1', article: 'Art. 20', categoryId: 'gov', weight: 2, mandatory: true, owner: { de: 'Geschäftsleitung', en: 'Management board', fr: 'Direction' }, name: { de: 'Verantwortung & Schulung der Geschäftsleitung', en: 'Management accountability & training', fr: 'Responsabilité de la direction' }, criteria: [
    ...
    { id: 'A21-1', article: 'Art. 21(2)(a)', categoryId: 'rm', mandatory: true, owner: { de: 'Risikomanagement', en: 'Risk management', fr: 'Gestion des risques' }, name: { de: 'Risikoanalyse & Sicherheitsrichtlinien', en: 'Risk analysis & security policies', fr: 'Analyse de risque & politiques' } },
    { id: 'A21-2', article: 'Art. 21(2)(b)', categoryId: 'ops', mandatory: true, owner: { de: 'Incident-Response-Team', en: 'Incident response team', fr: 'Équipe de réponse' }, name: { de: 'Bewältigung von Sicherheitsvorfällen', en: 'Incident handling', fr: 'Gestion des incidents' } },
    { id: 'A21-3', article: 'Art. 21(2)(c)', categoryId: 'ops', mandatory: true, owner: { de: 'IT-Betrieb', en: 'IT operations', fr: 'Exploitation IT' }, name: { de: 'Business Continuity & Backup-Management', en: 'Business continuity & backup', fr: 'Continuité & sauvegarde' } },
    { id: 'A21-4', article: 'Art. 21(2)(d)', categoryId: 'supply', mandatory: true, owner: { de: 'Einkauf / Lieferantenmgmt', en: 'Procurement / vendor mgmt', fr: 'Achats / fournisseurs' }, name: { de: 'Sicherheit der Lieferkette', en: 'Supply chain security', fr: 'Sécurité de la chaîne' } },
    { id: 'A21-5', article: 'Art. 21(2)(e)', categoryId: 'ops', mandatory: true, owner: { de: 'IT-Betrieb', en: 'IT operations', fr: 'Exploitation IT' }, name: { de: 'Sicherheit bei Beschaffung, Entwicklung & Wartung', en: 'Security in acquisition, development & maintenance', fr: 'Sécurité acquisition & maintenance' } },
    { id: 'A21-6', article: 'Art. 21(2)(f)', categoryId: 'rm', mandatory: true, owner: { de: 'CISO / IT-Sicherheit', en: 'CISO / IT security', fr: 'RSSI' }, name: { de: 'Bewertung der Wirksamkeit der Maßnahmen', en: 'Effectiveness assessment of measures', fr: "Évaluation de l'efficacité" } },
    { id: 'A21-7', article: 'Art. 21(2)(g)', categoryId: 'ops', mandatory: true, owner: { de: 'CISO / IT-Sicherheit', en: 'CISO / IT security', fr: 'RSSI' }, name: { de: 'Cyberhygiene & Schulungen', en: 'Cyber hygiene & training', fr: 'Cyberhygiène & formation' } },
    { id: 'A21-8', article: 'Art. 21(2)(h)', categoryId: 'tech', mandatory: true, owner: { de: 'IT-Sicherheit', en: 'IT security', fr: 'Sécurité IT' }, name: { de: 'Kryptografie & Verschlüsselung', en: 'Cryptography & encryption', fr: 'Cryptographie' } },
    { id: 'A21-9', article: 'Art. 21(2)(i)', categoryId: 'tech', mandatory: true, owner: { de: 'IT-Sicherheit / HR', en: 'IT security / HR', fr: 'Sécurité IT / RH' }, name: { de: 'Personalsicherheit & Zugriffskontrolle', en: 'HR security & access control', fr: 'Sécurité RH & accès' } },
    { id: 'A21-10', article: 'Art. 21(2)(j)', categoryId: 'tech', mandatory: true, owner: { de: 'IT-Sicherheit', en: 'IT security', fr: 'Sécurité IT' }, name: { de: 'MFA & gesicherte Kommunikation', en: 'MFA & secured communications', fr: 'MFA & communications' } },
