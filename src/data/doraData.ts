...
export const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    measures: { ict_risk_framework: { active: true, documented: true, audited: true, certified: false }, ict_config_mgmt: { active: true, documented: true, audited: true, certified: false }, encryption: { active: true, documented: true, audited: true, certified: false }, network_sec: { active: true, documented: true, audited: true, certified: false }, logging: { active: true, documented: true, audited: true, certified: false }, incident_mgmt: { active: true, documented: true, audited: true, certified: false }, bcm: { active: true, documented: true, audited: true, certified: false }, drp: { active: true, documented: true, audited: false, certified: false }, change_mgmt: { active: true, documented: true, audited: true, certified: false }, testing: { active: true, documented: true, audited: false, certified: false } },
